 ...
 *
 * See https://github.com/smkent/honeycomb-openscad
 */
...
module honeycomb(x, y, dia, wall, whole_only=false)  {
    difference() {
        square([x, y]);
        honeycomb_cutout(x, y, dia, wall, whole_only);
    }
}

// Trayshar: moved cutout to seperate module
module honeycomb_cutout(x, y, dia, wall, whole_only=false) {
    // Diagram
    //          ______     ___
    //         /     /\     |
    //        / dia /  \    | smallDia
